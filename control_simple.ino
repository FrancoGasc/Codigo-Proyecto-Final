// Version de control simple
//
// En esta versión se realiza la carga para una referencia constante, midiendo y presentando
// tensión, corriente y estado de carga de la batería.
// No se ejecutan las distintas etapas de carga, es solo una versión para mostrar el
...
void IRAM_ATTR Timer1_ISR(){  
  ...
  estadoDeCarga = estadoDeCarga + ( 5*2.5*promUltimasMedicionesCorriente) / (4096*3600*2.6); // probar multiplicando por 1000 para ver como cambia
...
void lazoControl(){
    ...
    if (i == 1){
      ...
      y_n_1 = y_n ;
      y_n = y_n_1 + 0.01005*x_n + 0.00995*x_n_1 ;
      D = y_n + 1843 ;
      i = 0;
    }
}

////////////////// Subrutina de estado inicial de carga //////////////////
int socVsTension(){
  for(int j = 0; j <=4 ; j++){
