// Version de control con etapas
//
// En esta versión se realiza la carga siguiendo el perfil CC-CV,
...
void loop2(void* pvParameters){
    for(;;){
      ...
      switch (etapaPrograma){
        case 0:
          if((promUltimasMedicionesTension > 2870)) { // 0.5*3.5*4096/2.5 = 2867 = 2900
            if(referenciaControl < 2100){
             referenciaControl = referenciaControl+100;                 // 1.3*4096/2.5 = 2129 
            }
            if(referenciaControl >= 2100){
              etapaPrograma = 1;
            }
        ...
        break;
        case 1:
          if(promUltimasMedicionesTension > 3440) { // 0.5*4.2*4096/2.5 = 3440 = 3400
            tensionAMantenerConstante = 2*promUltimasMedicionesTension + promUltimasMedicionesCorriente;
            etapaPrograma = 2;
          }
          else{
            etapaPrograma = 1;
        ...
        break;
        case 2:
          if(referenciaControl >1100){
           referenciaControl = tensionAMantenerConstante - 2*promUltimasMedicionesTension; 
          }
          if (referenciaControl <= 1100){
            etapaPrograma = 3;
          }
